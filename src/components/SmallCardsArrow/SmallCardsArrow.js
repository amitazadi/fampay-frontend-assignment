  ...
  return (
    <div className="small-card">
      <div className="small-card__content">
        ...
        <p className="small-card__content__title">{arr.map((val, i) => {
                if (val.includes('{}')) {
                  k++
                  return <span style={{color:props.formattedTitle.entities[k]?.color}}> {props.formattedTitle.entities[k].text} </span>
                } else {
